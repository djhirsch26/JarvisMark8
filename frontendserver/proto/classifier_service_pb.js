...
proto.classificaiton.ClassifyQueryResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.classificaiton.Intent.serializeBinaryToWriter
    );
  }
};
...
proto.classificaiton.ClassifyQueryResponse.prototype.getIntent = function() {
  return /** @type{?proto.classificaiton.Intent} */ (
    jspb.Message.getWrapperField(this, proto.classificaiton.Intent, 1));
};
...
proto.classificaiton.Intent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.classificaiton.Intent.Audio.serializeBinaryToWriter
    );
  }
...
proto.classificaiton.Intent.prototype.getAudio = function() {
  return /** @type{?proto.classificaiton.Intent.Audio} */ (
    jspb.Message.getWrapperField(this, proto.classificaiton.Intent.Audio, 1));
};
